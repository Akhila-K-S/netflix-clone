...
const Home = () => {
    ...
    return (
        <div className="App">
            <Banner />
            <RowPost data={originalsPosts} title={"Netflix Originals"} onVideoClick={(id) => onClickVideo(id)} />
            <RowPost data={actionPosts} title={"Action Movies"} isSmall onVideoClick={(id) => onClickVideo(id)} />
            <RowPost data={romanticPosts} title={"Romantic Movies"} isSmall onVideoClick={(id) => onClickVideo(id)} />
            <RowPost data={horrorPosts} title={"Horror Movies"} isSmall onVideoClick={(id) => onClickVideo(id)} />
        </div>
    );
};
